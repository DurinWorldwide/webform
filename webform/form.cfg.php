...
"settings":
{
	...
	"uid" : "2265f71e8142baf6e7eb2911b50ffa70",
	"validation_report" : "in_line"
},
"rules":{"text1":{"label":"Patient First Name","fieldtype":"text","required":true},"text2":{"label":"Patient Last Name","fieldtype":"text"},"radio3":{"label":"Select an option","required":false,"fieldtype":"radiogroup","values":["Radio 1","Radio 2","Radio 3"]},"checkbox4":{"checkbox":true,"number_required":0,"label":"Check options","fieldtype":"checkbox","values":["Check 1","Check 2","Check 3"]},"tel6":{"phone":"phoneUS","label":"Phone Number","fieldtype":"tel"},"regex7":{"label":"Regular Expression","fieldtype":"regex","regex_config":"/^[0-9]+$/"},"regex8":{"label":"Regular Expression","fieldtype":"regex","regex_config":"/^[0-9]+$/"},"regex9":{"label":"Regular Expression","fieldtype":"regex","regex_config":"/^[0-9]+$/"},"sigpad":{"sigpad":"enable","fieldtype":"sigpad","label":"Sign Below"}},
"payment_rules":{},
"conditional_rules":{"regex8":{"element":{"name":"radio3","operator":"is","value":"Radio 2"}},"regex9":{"element":{"name":"radio3","operator":"is","value":"Radio 2"}},"regex7":{"element":{"name":"radio3","operator":"is","value":"Radio 2"}},"tel6":{"element":{"name":"radio3","operator":"is","value":"Radio 2"}}},
